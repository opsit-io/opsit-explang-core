...
import static org.dudinea.explang.reader.LispReader._readChar;
import static org.dudinea.explang.reader.LispReader._unreadChar;
import static org.dudinea.explang.reader.LispReader.processChar;
...
public class MacroFuncs  {
	...
	public ASTN execute(char terminator,
			    PushbackReader is,
			    ReadTable  rt,
			    ParseCtx pctx) {
	...
	public ASTN execute(char dispChar,
			    PushbackReader is,
			    ReadTable  rt,
			    ParseCtx pctx) {
