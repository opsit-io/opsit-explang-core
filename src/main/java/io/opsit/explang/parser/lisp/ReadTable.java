...
public class ReadTable {
  ...
  protected final Map<Character,IReaderMacroFunc> readerMacroFunctions =
    Utils.map(';'  , LispParser.READ_COMMENT,
  ...
  {
    DispatchTable dt = new DispatchTable(Utils.map('(',  LispParser.SHARP_LEFT_PAREN,
                                                   '*', LispParser.SHARP_STAR,
                                                   '.', LispParser.SHARP_DOT,
                                                   ':', LispParser.SHARP_COLON,
                                                   'A', LispParser.SHARP_A,
                                                   'B', LispParser.SHARP_B,
                                                   'C', LispParser.SHARP_C,
                                                   'O', LispParser.SHARP_O,
                                                   'P', LispParser.SHARP_P,
                                                   'R', LispParser.SHARP_R,
                                                   'S', LispParser.SHARP_S,
                                                   'X', LispParser.SHARP_X,
                                                   ...
                                                   '<', LispParser.SHARP_ILLEGAL,
                                                   ' ', LispParser.SHARP_ILLEGAL,
                                                   8, LispParser.SHARP_ILLEGAL, // backspace
                                                   9, LispParser.SHARP_ILLEGAL, // tab
                                                   10, LispParser.SHARP_ILLEGAL, // newline, linefeed
                                                   12, LispParser.SHARP_ILLEGAL, // page
                                                   13, LispParser.SHARP_ILLEGAL)); // return
