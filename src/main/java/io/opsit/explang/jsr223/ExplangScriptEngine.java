...
public class ExplangScriptEngine implements ScriptEngine, Invocable {
  ...
  /**
   * <code>eval(Reader, Bindings)</code> calls the abstract <code>eval(Reader, ScriptContext)</code>
   * method, passing it a <code>ScriptContext</code> whose Reader, Writers and Bindings for scopes
   * other that <code>ENGINE_SCOPE</code> are identical to those members of the protected <code>
   * context</code> field. The specified <code>Bindings</code> is used instead of the <code>
   * ENGINE_SCOPE</code> <code>Bindings</code> of the <code>context</code> field.
   *
   * @param reader A <code>Reader</code> containing the source of the script.
   * @param bindings A <code>Bindings</code> to use for the <code>ENGINE_SCOPE</code> while the
   *     script executes.
  ...
  /**
   * Gets the value for the specified key in the <code>ENGINE_SCOPE</code> of the protected <code>
   * context</code> field.
   *
  ...
  /**
   * Returns the <code>Bindings</code> with the specified scope value in the protected <code>context
   * </code> field.
   *
  ...
  /**
   * Sets the value of the protected <code>context</code> field to the specified <code>ScriptContext
   * </code>.
   *
  ...
  /**
   * Returns a <code>SimpleScriptContext</code>. The <code>SimpleScriptContext</code>: <br>
   * <br>
   *
   * <ul>
   ...
   *   <li>Uses the Reader and Writer in the default <code>ScriptContext</code> of this <code>
   *       ScriptEngine</code>
   * </ul>
   *
   * <br>
