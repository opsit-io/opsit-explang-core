...
```
mvn org.apache.maven.plugins:maven-dependency-plugin:2.8:get -Dartifact=io.opsit:opsit-explang-core:0.0.4:jar:runnable   -Dtransitive=false -Ddest=opsit-explang-core-0.0.4-runnable.jar
```
...
```
$ java -jar opsit-explang-core-0.0.4-runnable.jar 
...
```shell
$ java -jar opsit-explang-core-0.0.4-runnable.jar ./examples/hello.l
Hello world
```
